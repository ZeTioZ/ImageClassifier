        ...
        <div class="relative bg-white rounded-lg shadow">
          ...
          <div class="p-6 space-y-6">
            ...
            <div class="flex justify-center items-center text-base leading-relaxed text-gray-500">
              <span>Netteté :</span>
              <input v-model="netteté" type="number" min="0" max="3000" class="w-1/4 h-8 bg-gray-50 text-gray-900 text-s rounded-md p-1 border-none shadow-none"/>
            </div>
            ...
            <div class="flex justify-center items-center text-base leading-relaxed text-gray-500">
              ...
              <input v-model="brigthness" type="number" min="0" max="100" class="w-1/4 h-8 bg-gray-50 text-gray-900 text-s rounded-md p-1 border-none shadow-none"/>
            </div>
            ...
            <p class="text-base leading-relaxed text-gray-500">
              ...
              autocomplete="off" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded block p-1 w-full" />
            </p>
          </div>
          <!-- Modal footer -->
          <div class="flex justify-evenly items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
